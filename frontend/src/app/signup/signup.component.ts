  ...
  onRegister(user: User): void {
    ...
    this.accountService.register(user).subscribe(
      response => {
        ...
        this.alertService.showAlert('You have registered successfully. Please check your email for account details.', AlertType.SUCCESS);
      ...
      (error: HttpErrorResponse) => {
        ...
        if (errorMsg === 'usernameExist') {
          ...
          this.alertService.showAlert('This email address already exists. Please try with a different email', AlertType.DANGER);
        } else {
